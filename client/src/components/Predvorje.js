...
import {fetchAllPostsAction,likePostAction,unLikePostAction} from '../actions/posts-actions'
...
likePost=(id)=>{
  if(this.props.allPosts.find(x => x._id === id).likes.includes(this.state.username)){this.props.unlikePost(id)}
else{this.props.likePost(id)}
}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Predvorje))
